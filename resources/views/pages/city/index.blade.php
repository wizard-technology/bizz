        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#cat" role="tab">All Citis</a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">City table</h4>
                                        <table id="datatable-buttons"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$value->id}}</td>
                                                    <td>{{$value->ct_name}}</td>
                                                    <td>{{$value->ct_name_kr}}</td>
                                                    <td>{{$value->ct_name_ku}}</td>
                                                    <td>{{$value->ct_name_ar}}</td>
                                                    <td>{{$value->ct_name_pr}}</td>
                                                    <td>{!! $value->ct_state == 1 ?'<span
                                                        ...
                                                        <div class="btn-group m-b-10">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="{{route('dashboard.city.edit',$value->id)}}">{{ $value->ct_state == 1 ? 'Inactive' :'Active'}}</a>
                                                                <button class="dropdown-item" data-toggle="modal"
                                                                    data-target=".bd-example-modal-form-{{$value->id}}">Edit</button>
                                                                <div class="dropdown-divider"></div>
                                                                <form
                                                                    action="{{route('dashboard.city.destroy',$value->id)}}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
                                                ...
                                                <div class="modal fade bd-example-modal-form-{{$value->id}}"
                                                    ...
                                                    aria-hidden="true">
                                                    <form action="{{route('dashboard.city.update',$value->id)}}"
                                                        method="post">
                                                        @method('PUT')
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    <div class="col-12">
                                                                                        <input class="form-control"
                                                                                            type="text" required=""
                                                                                            name="name arabic" dir="rtl"
                                                                                            placeholder="اسم"
                                                                                            id="tranlate_ar_{{$value->id}}"
                                                                                            value="{{$value->ct_name_ar}}">
